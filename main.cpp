...
int main() {
    ...
    return 0;
    /* Aquí hay un comentario de bloque, este programa puede ignorar el comentario aquí
         Hay muchos comentarios de línea, aquí escribí específicamente un pequeño comentario de bloque, el programa puede lograr esta función
    */
}
